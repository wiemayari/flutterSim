...
import 'package:fintech_dashboard_clone/models/enums/navigation_items.dart'; // Import the file where 'navigate' function is
                      ...
                      .map(
                        (e) => NavigationButton(
                          onPressed: () {
                            ...
                            navigate(context, e);  // Calls the navigate function
                          },
                          icon: e.icon,
